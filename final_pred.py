...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('D:\FINALPROJECT/cnn8grps_rad1_model.h5')
        ...
        self.T4.place(x=580, y=580)
        self.T4.config(text="", fg="red", font=("Courier", 30, "bold"))
